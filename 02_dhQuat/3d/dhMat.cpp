...
using namespace std;
ostream & operator<<(ostream & out, const dhMat m) {
   out <<  	m.v[0] << ", " << m.v[4]<< ", "<< m.v[8] << ", " << m.v[12] << endl <<
   			m.v[1] << ", " << m.v[5]<< ", "<< m.v[9] << ", " << m.v[13] << endl <<
			m.v[2] << ", " << m.v[6]<< ", "<< m.v[10] << ", " << m.v[14] << endl <<
			m.v[3] << ", " << m.v[7]<< ", "<< m.v[11] << ", " << m.v[15] << endl;
			  // access private data
   return out;
}
