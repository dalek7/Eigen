...
using namespace std;
ostream & operator<<(ostream & out, const dhVector v) {
   out << "(" << v.x << ", " << v.y<< ", "<< v.z <<  ")";  // access private data
   return out;
}
...
dhVector dhVector::operator/=(REAL f ) 
{
	//dhVector temp;
	if(f == 0) return *this;
...
REAL dhVector::LengthSquared() const
{
...
*/
/*
dhVector4 dhVector::asHomog()
{
	return dhVector4(x, y, z, 1);
}
*/
